...
L["Send a data sharing request to GUILD, RAID, PARTY, and BATTLEGROUND channels every time you login or /reloadui"] = "每次登录或重载界面就发送一个数据共享请求到 公会，团队，小队和战场频道" -- Needs review
