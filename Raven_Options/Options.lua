			...
			args = {
					...
					args = {
						LabelText = {
							...
							args = {
								...
								LabelFontSize = {
									type = "range", order = 15, name = L["Font Size"], min = 5, max = 30, step = 1,
						...
						PanelsBorders = {
							...
							args = {
								...
								PanelOffset = {
									...
									get = function(info) return MOD.db.global.Defaults.backdropOffset end,
									set = function(info, value) MOD.db.global.Defaults.backdropOffset = value; MOD:UpdateAllBarGroups() end,
								},
								PanelColor = {
								...
								BackdropTexture = {
									type = "select", order = 35, name = L["Background Border"], 
								...
								BackdropWidth = {
									type = "range", order = 40, name = L["Edge Size"], min = 0, max = 32, step = 0.1,
				...
				CustomBorderGroup = {
					...
					args = {
						...
						DefaultBorderColor = {
							type = "color", order = 40, name = L["Default Border Color"], hasAlpha = false,
							disabled = function(info) return (Raven.frame.SetTemplate and MOD.db.global.TukuiSkin) end,
					...
					args = {
						...
						ShowWhenGroup = {
							...
							args = {
								...
								PrimarySpec = {
									type = "toggle", order = 38, name = L["Primary Talents"],
									desc = L["If checked, bar group is shown when the player is in primary talents."],
									get = function(info) return GetBarGroupField("showPrimary") end,
									set = function(info, value) SetBarGroupField("showPrimary", value) end,
								},
								SecondarySpec = {
									type = "toggle", order = 39, name = L["Secondary Talents"],
									desc = L["If checked, bar group is shown when the player is in secondary talents."],
						...
						FilterGroup = {
							...
							args = {
								...
								AddFilter = {
									...
									disabled = function(info) return not GetBarGroupField("detectCooldowns") or not (GetBarGroupField("filterCooldown") or GetBarGroupField("showCooldown"))end,
									get = function(info) return nil end,
									set = function(info, value) value = ValidateSpellName(value); AddBarGroupFilter("Cooldown", value) end,
								},
								SelectFilter = {
									type = "select", order = 40, name = L["Filter List"],
									disabled = function(info) return not GetBarGroupField("detectCooldowns") or not (GetBarGroupField("filterCooldown") or GetBarGroupField("showCooldown"))end,
							...
							args = {
								...
								TimelineGroup = {
									...
									args = {
										...
										Exponent = {
											type = "range", order = 15, name = L["Exponent"], min = 1, max = 4, step = 0.25,
										...
										SplashEffect = {
											type = "toggle", order = 28, name = L["Splash Effect"],
										...
										Space1 = { type = "description", name = "", order = 30 },
										LabelList = {
											type = "input", order = 35, name = L["Label List"], width = "double",
										...
										Switcher = {
											type = "toggle", order = 40, name = L["Overlap Switch"],
											desc = L["If checked, when icons overlap, switch every two seconds which is shown on top (otherwise always show icon with shortest time remaining on top)."],
										...
										HideEmpty = {
											type = "toggle", order = 45, name = L["Hide Empty"],
								...
								PanelsBorders = {
									...
									args = {
										...
										PanelOffset = {
											...
											disabled = function(info) return GetBarGroupField("useDefaultFontsAndTextures") end,
											desc = L["Adjust padding between bar group and the background panel and border."],
											get = function(info) return GetBarGroupField("backdropOffset") end,
											set = function(info, value) SetBarGroupField("backdropOffset", value) end,
										},
										PanelColor = {
											type = "color", order = 25, name = L["Panel Color"], hasAlpha = true,
											disabled = function(info) return GetBarGroupField("useDefaultFontsAndTextures") end,
			...
			args = {
				...
				LayoutGroup = {
					...
					args = {
						...
						GridSize = {
							type = "range", order = 60, name = L["Icon Size"], min = 5, max = 25, step = 1,
						...
						GridAlpha = {
							...
							desc = L["Set opacity for the bar."],
							disabled = function(info) return not MOD.db.profile.InCombatBar.enable end,
				...
				EffectsGroup = {
					...
					args = {
						PulseStart = {
							...
							set = function(info, value) MOD.db.profile.InCombatBar.pulseStart = value end,
						},
						PulseEnd = {
							type = "toggle", order = 15, name = L["Pulse When Expiring"],
							desc = L["Enable icon pulse when bar is expiring."],
							...
							set = function(info, value) MOD.db.profile.InCombatBar.pulseEnd = value end,
						},
						FlashExpiring = {
							type = "toggle", order = 20, name = L["Flash When Expiring"],
							desc = L["Enable flashing of expiring bars."],
						...
						FlashTime = {
							...
							set = function(info, value) MOD.db.profile.InCombatBar.flashTime = value end,
						},
					},
				},
			},
			...
			args = {
				...
				Cooldowns = {
					...
					args = {
						...
						CooldownFontSize = {
							type = "range", order = 20, name = L["Font Size"], min = 5, max = 30, step = 1,
...
MOD.barOptions = {
	...
	OptionsGroup = {
		...
		args = {
			...
			LabelLink = {
				type = "toggle", order = 30, name = L["Label Link"],
