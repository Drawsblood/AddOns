...
L["prox_desc"] = "Установка индикатора дальности на значение 15 метров с отображением других танков поможет делить урон от способности |cff66bbffКаменные кулаки|r."
