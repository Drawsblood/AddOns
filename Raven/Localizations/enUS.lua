...
L["If checked, bar group is shown when the player is in primary talents."] = true
L["Secondary Talents"] = true
L["If checked, bar group is shown when the player is in secondary talents."] = true
L["Has Pet"] = true
L["No Pet"] = true
...
L["Enter Spell"] = true
L["Enter a spell name (or numeric identifier, optionally preceded by # for a specific spell id) to be added to the list."] = true
...
L["If checked, when icons overlap, switch every two seconds which is shown on top (otherwise always show icon with shortest time remaining on top)."] = true
L["Hide Empty"] = true
...
L["Other Spell"] = true
L["Enter spell name (or numeric identifier) to associate with a bar."] = true
