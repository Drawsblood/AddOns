...
WardrobeText["enUS"] = {
	...
	CONFIG_WEAROUTFIT_INFO		= "Equip the items from the outfit of your choice.";
	...
	SWIMBUTTON_TIP1     = "Wear the selected outfit\nwhen you are swimming.";
	...
	TXT_TOOLTIPS_ENABLED       = "Tooltips Enabled.";
	TXT_TOOLTIPS_DISABLED      = "Tooltips Disabled.";
