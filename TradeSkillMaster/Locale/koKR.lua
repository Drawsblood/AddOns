...
L["AuctionDB can put market value, min buyout, and seen count info into item tooltips. You can turn this on / off in the options tab of the AuctionDB page."] = "옥션DB는 경매 시세와 최소 즉구가, 갯수 정보를 아이템 툴팁에 추가합니다. 옥션DB의 옵션 탭에서 켜고 끌수 있습니다." -- Needs review
...
L["Auctioning's CancelAll scan can be used to quickly cancel specific items. Anything from items under a certain duration to specific items, to entire groups."] = "옥셔닝의 모두취소는 특정한 아이템들을 빠르게 취소 할 수 있도록 검색 해줍니다. 남은 경매시간, 특정 아이템들을 그룹으로 설정 할 수 있습니다." -- Needs review
...
L["Crafting can make Auctioning groups for you. Just click on a profession icon, a category, and then the \"Create Auctioning Groups\" button."] = "크래프팅은 옥셔닝 그룹을 만들수 있게 합니다. 전문기술 아이콘, 카테고리, 그리고\"옥셔닝 그룹 생성\" 버튼을 클릭하세요" -- Needs review
-- L["Crafting Cost"] = ""
L["Crafting's on-hand queue will queue up the most profitable items you can make from the materials you have in your bags."] = "크래프팅의 온-핸드 큐는 당신이 소지하고 있는 재료들로 만들수 있는 아이템들을 가장 수익이 높은 아이템들 순으로 보여줍니다." -- Needs review
L["Credits"] = "제작" -- Needs review
-- L["Date:"] = ""
...
-- L["General Settings"] = ""
L["Have you tried running a GetAll scan? It's the fastest possible way to scan by far so give it a shot!"] = "모두얻기 검색을 시도해 보셨습니까? 한방에 이 모든 것을 가능케하는 가장 빠른 방법입니다." -- Needs review
-- L["Hide Minimap Icon"] = ""
-- L["I am a bot!"] = ""
-- L["I am human!"] = ""
...
L["If the Craft Management Window is too big, you can scale it down in the Crafting options."] = "만약 제작 관리 창이 너무 크다면, 크래프팅 옵션 창에서 크기를 조절 할 수 있습니다." -- Needs review
-- L["I'll Go There Now!"] = ""
...
L["Lead Developer and Project Manager:"] = "주 개발자와 프로젝트 매니저:" -- Needs review
...
L["TradeSkillMaster Team:"] = "트레이드스킬마스터 팀:" -- Needs review
