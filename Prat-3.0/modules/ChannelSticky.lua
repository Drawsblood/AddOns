...
L:AddLocale("koKR",
{
	...
	smartgroup_desc = "자동으로 유효한 대화 형식을 선택하도록 /gr 명령어를 추가합니다. (공격대, 파티 또는 전장)",
	smartgroup_name = "스마트 그룹",
	["Sticky Per Chat Frame"] = "대화창 별 고정",
	["Sticky %s"] = "%s 고정",
	["Toggle remembering the chat type last used per chat frame."] = "대화창 별로 마지막으로 사용한 대화 형식 기억하기.",
	["Toggles sticky on and off for %s."] = "%s의 입력 고정 켜거나 끄기.",
}
