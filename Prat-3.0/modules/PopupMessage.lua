...
L:AddLocale("koKR",  
{
	...
	["Clear Nickname"] = "별명 클리어",
	["Clears alternate name to show in popups."] = "팝업으로 표시될 별명을 클리어합니다.",
	...
	["Toggle setting options separately for each chat window."] = "각 채팅창 별로 설정 옵션 분리 끄거나 켜기.",
}
