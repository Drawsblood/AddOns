...
L:AddLocale("koKR",  
{
	...
	["<command>[ <value>] - alias <command> to be executed as <value>, or return the value of the currently defined alias for <command> if <command> has not been assigned a value. eg: \"/alias /examplehello /say hello there\" - typing \"/examplehello\" will now cause your character to say \"hello there\"; \"/alias examplehello\" - s \"/examplehello is aliased to /say hello there\" (cmd aliases: /addalias)"] = "<명령어>[<인자>] - <명령어>로 <인자>를 수행하게 대체하거나, <명령어>에 할당된 인자가 없으면 <명령어>에 설정된 대체 명령어를 출력. 예제: \"/alias /꾸벅 /say 안녕하세요\" - \"/꾸벅\" 명령어로 일반 대화 \"안녕하세요\"가 수행됨;\"/alias 꾸벅\" - \"/꾸벅 명령어가 /say 안녕하세요 로 대체됨\" 이 표시됨 (명령어: /addalias)",
	["dealiasing command /%s to /%s"] = "/%s|1을;를; /%s|1으로;로; 대체 명령어 해제",
	...
	["infinite loop detected for alias /%s - ignoring"] = "대체 명령어 /%s |1이;가; 무한루프에 걸림 - 무시됨",
	inline = true,
	...
	["matching aliases found: %d"] = "일치하는 대체 명령어 찾음: %d 개",
	module_desc = "UNIX의 alias 명령과 비슷한 방법으로 슬래쉬 명령어를 대체하는데 사용하는 /alias 명령을 추가합니다.",
	module_name = "대체 명령어",
	["No aliases have been defined"] = "설정된 대체 명령어가 없습니다.",
	noclobber = "덮어쓰기 금지",
	["noclobber set - skipping new alias: /%s already expands to /%s"] = "덮어쓰기 금지 - 대체 명령어 추가 무시됨 : /%s |1은;는; 이미 /%s |1으로;로; 설정되어 있음.",
	Options = "옵션",
	["Options for altering the behaviour of Alias"] = "대체 명령어의 작동을 바꾸는 옵션",
	["overwriting existing alias \"/%s\" (was aliased to \"/%s\")"] = "이미있는 대체 명령어 \"/%s\"(\"/%s\" |1으로;로; 설정되어 있음) 덮어쓰기",
	["refusing to alias \"/%s\" to anything in the interests of Not Buggering Everything Up"] = "\"/%s\" |1은;는; 중요 명령어로 사용 중이어서 대체 명령어 사용으로 거부됨.",
	["remove an alias"] = "대체 명령어를 제거합니다.",
	["/%s aliased to \"/%s\""] = "/%s |1이;가; \"/%s\"|1으로;로; 대체됨",
	["/%s aliased to: /%s"] = "/%s |1이;가; \"/%s\"|1으로;로; 대체됨",
	...
	["warnUser() called with zero length string!"] = "warnUser() 함수가 공백 문자열 옵션으로 호출됨!",
}
