...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("koKR",
  {
	...
	Colour = "색상",
	["%d alts found for %s: %s"] = "%s의 대체명 %d 찾음: %s",
	...
	["List all"] = "모든 목록",
	["List all links between alts and their main names."] = "대체명과 거의 메인 이름 간의 모든 연결 목록.",
	["List alts"] = "대체명 목록",
	...
	["No main name supplied to link %s to"] = "%s와 연결할 메인 이름 제공되지 않음",
