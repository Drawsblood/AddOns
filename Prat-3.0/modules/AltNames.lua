...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("koKR",
  {
	...
	alt = "대체",
	Alt = "대체",
	["<alt name> (eg, /altnames del Personyouthoughtwassomeonesaltbutreallyisnt)"] = "<대체명> (예, /altnames del Personyouthoughtwassomeonesaltbutreallyisnt)",
	["alt name exists: %s -> %s; not overwriting as set in preferences"] = "대체명 존재: %s -> %s; 우선권 설정으로 덮어쓰지 않았습니다",
	AltNames = "대체명",
	["Alts:"] = "대체:",
	autoguildalts_desc = "자동으로 길드 정보 가져오기 명령을 실행합니다",
	autoguildalts_name = "길드 대체명 자동 가져오기",
	["Be quiet"] = "조용하게",
	["character removed: %s"] = "글자 제거됨: %s",
	["Class colour"] = "직업 색상",
	["Clear all"] = "모두 지우기",
	["Clear all links between alts and main names."] = "대체명과 메인 이름 사이의 모든 연결 지우기.",
	Colour = "색상",
	["%d alts found for %s: %s"] = "%s의 대체명 %d개 찾음: %s",
	["Delete a character's link to another character as their main."] = "다른 문자와 메인으로 연결된 문자의 연결 삭제",
	["Delete alt"] = "대체명 삭제",
	Disabled = "비활성",
	["Display a player's alts in the tooltip"] = "툴팁에 풀레이어의 대체명 표시하기",
	["Display a player's main name in the tooltip"] = "툴팁에 플레이어의 메인 이름 표시하기",
	["Display main names in the same colour as that of the alt's class (taking the data from the PlayerNames module if it is enabled)"] = "대체명의 직업과 같은 색상으로 메인 이름 표시하기 (플레이어 이름 모듈을 사용 중이면 모듈로부터 데이터를 가져옵니다)",
	["Display main names in the same colour as that of the main's class (taking the data from the PlayerNames module if it is enabled)"] = "메인의 직업과 같은 색상으로 메인 이름 표시하기 (플레이어 이름 모듈을 사용 중이면 모듈로부터 데이터를 가져옵니다)",
	["Don't overwrite existing alt <-> main links when importing or adding new alts."] = "존재하는 대체명을 덮어쓰지 않기 <-> 새로운 대체명을 가져오거나 추가할 때 메인과 연결하기.",
	["Don't overwrite existing links"] = "존재 하는 연결을 덮어쓰지 않기",
	["don't use"] = "사용하지 않음",
	["Don't use data from the PlayerNames module at all"] = "플레이어 이름 모듈로부터 데이터 사용하지 않기",
	["ERROR: some function sent a blank message!"] = "오류: 몇몇 함수가 빈 메시지를 보냈습니다!",
	["Find characters"] = "글자 찾기",
	["Fix alts"] = "대체명 고치기",
	["Fix corrupted entries in your list of alt names."] = "당신의 대체명 목록에서 잘못된 목록을 고칩니다.",
	["Found alt: %s => main: %s"] = "대체명 찾음: %s => 메인: %s",
	["guild member alts found and imported: %s"] = "길드원 대체명 발견하고 가져옴: %s",
	["Import from Guild Greet database"] = "길드 쪽지 데이터베이스로부터 가져오기",
	["Import from guild roster"] = "길드 정보로부터 가져오기",
	["Import options"] = "옵션 가져오기",
	["Imports alt names from a Guild Greet database, if present"] = "존재한다면 길드 쪽지 데이터베이스로부터 대체명을 가져옵니다",
	["Imports alt names from the guild roster by checking for members with the rank \"alt\" or \"alts\", or guild / officer notes like \"<name>'s alt\""] = "\"alt\" 또는 \"alts\" 등급, 또는 \"<이름>의 alt\"같은 길드 / 관리자 쪽지를 체크하여 대체명을 가져옵니다",
	["Imports data from LOKWhoIsWho, if present (drop your SavedVariablesLOKWhoIsWho.lua in the Prat directory to be able to use this)."] = "존재한다면 LOKWhoIsWho로부터 데이터를 가져옵니다 (SavedVariablesLOKWhoIsWho.lua 파일을 Prat 디렉토리에 복사해야 사용 가능함).",
	Left = "왼쪽",
	["Link alt"] = "대체명 연결",
	["link <alt name> <main name> (eg, /altnames link Fin Finjathealtoffin)"] = "link <대체명> <메인 이름> (예, /altnames link Fin Finjathealtoffin)",
	["linked alt %s => %s"] = "대체명 연결됨 %s => %s",
	["Link someone's alt character with the name of their main."] = "누군가의 대체 글자를 그의 메인 이름과 연결시키기.",
	["List all"] = "모든 목록",
	["List all links between alts and their main names."] = "대체명과 메인 이름 간의 모든 연결 목록 표시.",
	["List alts"] = "대체명 목록",
	["List alts for a given character"] = "주어진 글자의 대체명 목록",
	...
	Main = "메인",
	["Main:"] = "메인:",
	["<main> (eg /altnames listalts Fin)"] = "<메인> (예 /altnames listalts Fin)",
	["Main name position"] = "메인 이름 위치",
	mainpos_desc = "대체명을 사용할 때 글자의 메인 이름을 표시할 곳.",
	mainpos_name = "메인 이름 위치",
	module_desc = "사람들의 대체 글자를 그들의 메인과 연결하도록 허용합니다, 대화 메시지에서 발견되면 그들의 이름 다음에 표시되게 할 수 있습니다 (기본값=끔).",
	["no alts found for character "] = "글자에 대한 대체를 발견하지 못함",
	["no alts or mains found matching \"%s\""] = "\"%s\"|1과;와; 일치하는 대체나 메인을 찾을 수 없음",
	["No arg string given to :addAlt()"] = ":addAlt()에 변수 구문 주어지지 않음",
	["no characters called \"%s\" found; nothing deleted"] = "\"%s\"|1으로;로; 불려지는 글자 찾을 수 없음; 삭제하지 못함",
	["No Guild Greet database found"] = "길드 쪽지 데이터베이스 찾을 수 없음",
	["No main name supplied to link %s to"] = "%s|1과;와; 연결할 메인 이름 제공되지 않음",
	["no matches found"] = "일치 하는 것 없음",
	quiet = "조용하게",
	quiet_desc = "대화창에 보고할 지 안할 지 여부.",
	quiet_name = true,
	Right = "오른쪽",
	["(.-)'s? [Aa]lt"] = "%f[%a\\192-\\255]([%a\\192-\\255]+)%f[^%a\\128-\\255]의 대체명",
	["%s alts imported from LOKWhoIsWho"] = "%s 대체명 LOKWhoIsWho로부터 가져옴",
	["searched for: %s - total matches: %s"] = "검색: %s - 총 일치: %s",
	["<search term> (eg, /altnames find fin)"] = "<검색 구문> (예, /altnames find fin)",
	["Search the list of linked characters for matching main or alt names."] = "메인 또는 대체명과 일치하는 연결된 문자의 목록 검색",
	["Show alts in tooltip"] = "툴팁에 대체명 표시",
	["Show main in tooltip"] = "툴팁에 메인 표시",
	["([^%s%p%d%c%z]+)'s alt"] = "%f[%a\\192-\\255]([%a\\192-\\255]+)%f[^%a\\128-\\255]의 대체명",
	Start = "시작",
	["%s total alts linked to mains"] = "%s 모든 대체명 메인과 연결됨",
	["The colour of an alt's main name that will be displayed"] = "표시될 대체의 메인 이름의 색상",
	["Use class colour (from the PlayerNames module)"] = "직업 색상 사용 (플레이어 이름 모듈로부터)",
	["use class colour of alt"] = "대체의 직업 색상 사용",
	["use class colour of main"] = "메인의 직업 색상 사용",
	["Use LibAlts Data"] = "LibAlts 데이터 사용",
	["Use the data available via the shared alt information library."] = "대체 정보 라이브러리를 통해 공유된 데이터 사용하기.",
	["Various ways to import a main's alts from other addons"] = "다른 애드온으로부터 메인의 대체를 가져올 다양한 방법들",
	["warning: alt %s already linked to %s"] = "경고: 대체 %s|1은;는; 이미 %s|1과;와; 연결됨",
	["Where to display a character's main name when on their alt."] = "대체명을 사용할 때 글자의 메인 이름을 표시할 곳",
	["Whether to report to the chat frame or not."] = "대화창에 보고 여부",
	["You are not in a guild"] = "당신은 길드에 속해 있지 않습니다",
	["You have not yet linked any alts with their mains."] = "아직 메인과 대체명을 연결하지 않았습니다.",
}
