...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("koKR",
  {
	...
	guild_name = "길드",
	incoming = "들어오는",
	["Incoming Sounds"] = "들어올 때 소리",
	officer_desc = "%s 관리자 채널 메시지 소리",
	officer_name = "관리자",
	outgoing = "나가는",
	["Outgoing Sounds"] = "나갈 때 소리",
	...
	Sounds = "소리",
	["Sound selection for incoming chat messages"] = "들어오는 대화 메시지의 소리 선택",
	["Sound selection for outgoing (from you) chat messages"] = "나가는 (당신으로 부터) 대화 메시지의 소리 선택",
