...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("koKR",
  {
	["Add a pattern to search for."] = "검색할 패턴 추가.",
	["Add Pattern"] = "패턴 추가",
	...
	["Only output the message portion of the chat text, leave out the channel, and playername etc."] = "대화 문자열, 채널 나감, 플레이어 이름 등의 메시지 부분만 출력하기.",
	Outbound = "내보내는",
	...
	["Play Sound"] = "소리 재생",
	["Prevent the message from being displayed"] = "보여지고 있는 메시지 차단하기",
	["Remove an existing pattern."] = "존재하는 패턴을 제거합니다.",
	["Remove Pattern"] = "패턴 삭제",
	["Replacement Text"] = "대체 텍스트",
	["Search Format String"] = "검색 형식 구문",
