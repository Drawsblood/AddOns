...
L:AddLocale("koKR",  
{
	...
	["Chat window font options."] = "대화창 글꼴 옵션",
	Font = "글꼴",
	...
	["Set text font size."] = "글꼴 크기 설정",
	["Set text font size for each chat window."] = "각각의 대화창에 대하여 글꼴 크기를 설정합니다.",
	["Set the text font face for all chat windows."] = "모든 채팅창의 글꼴를 설정합니다.",
	shadowcolor_desc = "그림자 색깔을 설정합니다.",
	shadowcolor_name = "그림자 색깔 설정",
	["Thick Outline"] = "두꺼운 외곽선",
	["Toggle setting options separately for each chat window."] = "각각의 대화창에 대한 옵션 설정을 끄고 켭니다.",
