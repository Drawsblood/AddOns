...
L:AddLocale("koKR",  
{
	...
	Bottom = "최하단",
	Clickable = "클릭 가능한",
	["Click the edit box to open it up for editing. Only available if Autohide is disabled."] = "대화 입력창을 클릭하여 편집할 수 있게 엽니다. 자동숨김이 꺼져있을 때만 사용할 수 있습니다.",
	DIALOG = "대화",
	...
	["Hide the edit box after you have pressed enter."] = "엔터를 누른 후에 입력 창 숨기기.",
	HIGH = "높음",
