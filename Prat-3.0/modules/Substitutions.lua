...
L:AddLocale("koKR",  
{
	["A module to provide basic chat substitutions."] = "기본적인 대화 대리명을 제공하는 모듈입니다.",
	["Are you sure?"] = "동의합니까?",
	["Are you sure - this will delete all user defined substitutions and reset defaults?"] = "정말로 모든 사용자 정의 대리명을 삭제하고 기본값으로 초기화할까요?",
	["can't find substitution index for a substitution named '%s'"] = "'%s' 대용어의 값을 찾을 수 없습니다",
	["|cffff0000warning:|r subtitution \"%s\" already defined as \"%s\", overwriting"] = "|cffff0000경고:|r 대용어 \"%s\"은 이미 \"%s\"로 정의 되었습니다, 덮어씁니다",
	[ [=[Current value: '%s'
Click to paste into the chat.]=] ] = [=[현재 값: '%s'
클릭하여 대화창에 붙여넣기.]=],
	["defined %s: expands to => %s"] = "'%s' 정의: 확장됨 => %s",
	["Delete all"] = "전부 삭제",
	["Deletes all user defined substitutions"] = "모든 사용자 정의 대리명 삭제하기",
	["Deletes a user defined substitution"] = "사용자 정의 대리명 삭제하기",
	["Delete substitution"] = "대리명 삭제",
	...
	it = "그것",
	its = "그것의",
	["List of available substitutions"] = "사용 가능한 대리명 목록",
	["List of available substitutions defined by this module. (NB: users may define custom values for existing substitutions, but they will revert to the default value if the user definition is deleted.)"] = "이 모듈로 사용 가능한 대용어 목록입니다. (NB: 존재하는 대용어에 사용자 설정 값을 정의 할 수 있지만, 사용자 정의 값이 삭제되면 기본 값으로 전환됩니다.)",
	["Lists all current subtitutions in the default chat frame"] = "기본 대화창의 현재 모든 대리명 목록",
	["List substitutions"] = "대리명 목록",
	male = "남자",
	MapLoc = "지도 위치",
	MapPos = "지도 좌표",
	MapXPos = "지도 X좌표",
	MapYPos = "지도 Y좌표",
	MapZone = "지도 지역",
	["module:buildUserSubsIndex(): warning: module patterns not defined!"] = "module:buildUserSubsIndex(): 경고: 모듈 패턴 정의되지 않음!",
	...
	["Options for setting and removing user defined substitutions. (NB: users may define custom values for existing substitutions, but they will revert to the default value if the user definition is deleted.)"] = "사용자 정의 대용어을 설정하거나 제거하는 옵션입니다. (NB: 존재하는 대용어에 사용자 설정 값을 정의 할 수 있지만, 사용자 정의 값을 삭제하면 기본값으로 전환됩니다.)",
