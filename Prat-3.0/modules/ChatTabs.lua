...
L:AddLocale("deDE", 
{
	...
	All = "Alle",
	Always = "Immer",
	["Chat window tab options."] = "Optionen für Tabs der Chatfenster",
	Default = "Standard",
	...
	preventdrag_desc = "Das Ziehen der Tabs von Chatfenstern mit der Maus verhindern.",
	...
	["Sets alpha of chat tab for active chat frame."] = "Transparenz der Chat-Tabs von aktiven Chatfenstern einstellen.",
	["Sets alpha of chat tab for not active chat frame."] = "Transparenz der Chat-Tabs von inaktiven Chatfenstern einstellen.",
	["Set tab display mode for each chat window."] = "Tabdarstellungsmodus für jedes Chatfenster einstellen: markiert (an), nicht markiert (aus), grau markiert (standard)",
	...
	Tabs = "Tabs (Reiter der Chatfenster)",
}
...
L:AddLocale("koKR",  
{
	...
	["Set tab display mode for each chat window."] = "각각의 대화창에 대한 탭 표시 모드 설정",
