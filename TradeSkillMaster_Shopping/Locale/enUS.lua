...
L["The options below control the \"Quick Posting\" window that is shown on the right of auction frame inside the \"Search\" feature. When you shift-click on an item within this window, it will be posted according to the settings below as well as the duration and bid percent settings set in the \"Post Options\" section below."] = true
L["Quick Posting Options"] = true
L["Quick Post Price Source"] = true
L["Specifies the price source listed in the quick post window. This is the price used when you shift-click on an item."] = true
L["Quick Post Max Stack Size"] = true
L["When you shift-click an item in the quick post window, a single auction will be created in as large a stack as possible, up to this stack size."] = true
L["Hide Items in Auctioning Groups"] = true
L["If checked, items which are in Auctioning groups will not be shown in the quick posting window."] = true
...
L["Special Searches"] = true
L["Shopping - Quick Posting"] = true
L["Quick Posting"] = true
L["Show/Hide the quick posting frame. This frame shows all the items in your bags and allows you to quickly post them."] = true
...
L["Click on an item to search for it.\nShift-click to post it at the listed item value."] = true
L["Open Quick Auctions Window by Default"] = true
L["If checked, the quick posting window will automatically open by default."] = true