...
elseif GAME_LOCALE == "itIT" then
	lib:SetCurrentTranslations {
	Alliance = "Alleanza", -- Needs review
	["Alliance Vanguard"] = "Avanguardia Dell'Alleanza", -- Needs review
	["Argent Crusade"] = "Crociata d'Argento", -- Needs review
	["Argent Dawn"] = "Alba D'Argento", -- Needs review
	["Ashtongue Deathsworn"] = "Congiurati di Linguamorta", -- Needs review
	["Avengers of Hyjal"] = "Vendicatori di Hyjal", -- Needs review
	["Baradin's Wardens"] = "Custodi di Baradin", -- Needs review
	["Bilgewater Cartel"] = "Cartello degli Acqualorda", -- Needs review
	["Bloodsail Buccaneers"] = "Bucanieri Velerosse", -- Needs review
	["Booty Bay"] = "Baia del Bottino", -- Needs review
	["Brood of Nozdormu"] = "Stirpe di Nozdormu", -- Needs review
	["Cenarion Circle"] = "Circolo Cenariano", -- Needs review
	["Cenarion Expedition"] = "Spedizione Cenariana", -- Needs review
	["Darkmoon Faire"] = "Fiera di Lunacupa", -- Needs review
	["Darkspear Trolls"] = "Troll Lanciascura", -- Needs review
	Darnassus = "Darnassus", -- Needs review
	["Dragonmaw Clan"] = "Clan Fauci di Drago", -- Needs review
	Everlook = "Lungavista", -- Needs review
	Exalted = "Osannato", -- Needs review
	Exodar = "Exodar", -- Needs review
	["Explorers' League"] = "Lega degli Esploratori", -- Needs review
	["Frenzyheart Tribe"] = "Tribù dei Cuorferoce", -- Needs review
	Friendly = "Amichevole", -- Needs review
	["Frostwolf Clan"] = "Clan Lupi Bianchi", -- Needs review
	Gadgetzan = "Meccania", -- Needs review
	["Gelkis Clan Centaur"] = "Centauri del Clan Gelkis", -- Needs review
	Gilneas = "Gilneas", -- Needs review
	Gnomeregan = "Gnomeregan", -- Needs review
	-- ["Gnomeregan Exiles"] = "",
	["Guardians of Hyjal"] = "Guardiani di Hyjal", -- Needs review
	Guild = "Gilda", -- Needs review
	["Hellscream's Reach"] = "Avanguardia di Malogrido", -- Needs review
	Honored = "Onorato", -- Needs review
	["Honor Hold"] = "Rocca dell'Onore", -- Needs review
	Horde = "Orda", -- Needs review
	["Horde Expedition"] = "Spedizione dell'Orda", -- Needs review
	["Hydraxian Waterlords"] = "Seguaci di Hydraxian", -- Needs review
	Ironforge = "Foggiardente", -- Needs review
	["Keepers of Time"] = "Custodi del Tempo", -- Needs review
	["Kirin Tor"] = "Kirin Tor", -- Needs review
	["Knights of the Ebon Blade"] = "Cavalieri della Spada d'Ebano", -- Needs review
	Kurenai = "Kurenai", -- Needs review
	["Lower City"] = "Città Bassa", -- Needs review
	["Magram Clan Centaur"] = "Centauri del Clan Magram", -- Needs review
	Netherwing = "Alafatua", -- Needs review
	Neutral = "Neutrale", -- Needs review
	["Ogri'la"] = "Ogri'la", -- Needs review
	Orgrimmar = "Orgrimmar", -- Needs review
	Ramkahen = "Ramkahen", -- Needs review
	Ratchet = "Porto Paranco", -- Needs review
	Ravenholdt = "Corvolesto", -- Needs review
	Revered = "Riverito", -- Needs review
	["Sha'tari Skyguard"] = "Guardiacieli Sha'tari", -- Needs review
	["Shattered Sun Offensive"] = "Offensiva del Sole Infranto", -- Needs review
	["Shen'dralar"] = "Shen'dralar", -- Needs review
	["Silvermoon City"] = "Lunargenta", -- Needs review
	["Silverwing Sentinels"] = "Sentinelle Alargentea", -- Needs review
	Sporeggar = "Sporeggar", -- Needs review
	["Stormpike Guard"] = "Guardia dei Piccatonante", -- Needs review
	Stormwind = "Roccavento", -- Needs review
	Syndicate = "Lega dei Tagliagole", -- Needs review
	["The Aldor"] = "Veggenti", -- Needs review
	["The Ashen Verdict"] = "Verdetto Cinereo", -- Needs review
	["The Consortium"] = "Consorzio", -- Needs review
	["The Defilers"] = "Profanatori", -- Needs review
	["The Earthen Ring"] = "Circolo della Terra", -- Needs review
	["The Frostborn"] = "Figli del Gelo", -- Needs review
	["The Hand of Vengeance"] = "Mano della Vendetta", -- Needs review
	["The Kalu'ak"] = "Kalu'ak", -- Needs review
	["The League of Arathor"] = "Lega di Arathor", -- Needs review
	["The Mag'har"] = "Mag'har", -- Needs review
	["The Oracles"] = "Tribù degli Oracoli", -- Needs review
	Therazane = "Therazane", -- Needs review
	["The Scale of the Sands"] = "Scale delle Sabbie", -- Needs review
	["The Scryers"] = "Veggenti", -- Needs review
	["The Sha'tar"] = "Sha'tar", -- Needs review
	["The Silver Covenant"] = "Patto d'Argento", -- Needs review
	["The Sons of Hodir"] = "Figli di Hodir", -- Needs review
	["The Sunreavers"] = "Predatori del Sole", -- Needs review
	["The Taunka"] = "Taunka", -- Needs review
	["The Violet Eye"] = "Occhio Violaceo", -- Needs review
	["The Wyrmrest Accord"] = "Lega dei Draghi", -- Needs review
	["Thorium Brotherhood"] = "Fratellanza del Torio", -- Needs review
	Thrallmar = "Thrallmar", -- Needs review
	["Thunder Bluff"] = "Picco del Tuono", -- Needs review
	["Timbermaw Hold"] = "Rifugio dei Mordilegno", -- Needs review
	Tranquillien = "Tranquillien", -- Needs review
	Undercity = "Sepulcra", -- Needs review
	["Valiance Expedition"] = "Spedizione degli Arditi", -- Needs review
	["Warsong Offensive"] = "Offensiva dei Cantaguerra", -- Needs review
	["Warsong Outriders"] = "Predoni Cantaguerra", -- Needs review
	["Wildhammer Clan"] = "Clan Granmartello", -- Needs review
	["Winterfin Retreat"] = "Rifugio dei Pinnafredda", -- Needs review
	["Wintersaber Trainers"] = "Addestratori delle Fiere Glaciali", -- Needs review
	["Zandalar Tribe"] = "Tribù Zandalari", -- Needs review
}
