...
PvPTitle:SetPoint("TOPLEFT", EquipmentBuddyOptions.panel, "TOPLEFT", 210, -160)
...
Tree1pvp:SetPoint("RIGHT", EquipmentBuddyOptions.panel, "RIGHT", -300, 90)

local Tree2pvp = EquipmentBuddyOptions.panel:CreateFontString("Tree2pvp", "ARTWORK", "GameFontNormal")
Tree2pvp:SetPoint("RIGHT", EquipmentBuddyOptions.panel, "RIGHT", -170, 90)
...
local secondarySpec = GetSpecialization(false, false, 2)
		if primarySpec ~= nil then
			...
			Tree1:SetText("Primary Set")
			Tree1pvp:SetText("Primary Set")
		end
		...
		if secondarySpec ~= nil then
			...
			Tree2:SetText("Secondary Set")
			Tree2pvp:SetText("Secondary Set")
		end
end
...
Fifth:SetPoint("TOPRIGHT", -405, -200);
...
Sixth:SetPoint("TOPRIGHT", -275, -200);
