...
L["Delay"] = "Verzögerung"
L["Desaturated Icons"] = "Graue Icons" -- Needs review
...
L["How should the plugin width adapt to the text?"] = "Wie soll sich die Breite des Plugins an den Text anpassen?" -- Needs review
...
L["Set fixed or max width for the text."] = "Lege feste oder maximale Breite für den Text fest." -- Needs review
...
L["Show icons in gray scale mode (This will not affect icons embedded in the text of a plugin)."] = "Icons in Graustufen anzeigen. (Dies betrifft keine Icons, die im Text eines Plugins eingebettet sind.)" -- Needs review
...
L["Width Behavior"] = "Breitenverhalten" -- Needs review
