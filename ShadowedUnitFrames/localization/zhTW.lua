...
L["Adds a bar inside the health bar indicating how much healing someone will receive."] = "增加一個條在生命條中以顯示某些人將獲得多少治療。" -- Needs review
...
L["Banked Holy Power"] = "儲備的神聖能量" -- Needs review
L["Bar alpha"] = "計量調透明度"
...
L["Buffs"] = "增益"
L["Burning Embers"] = "燃燒餘燼" -- Needs review
L["Burning Embers bar"] = "燃燒餘燼條" -- Needs review
L["C"] = "C"
...
L["Currently modifying"] = "目前的設定" -- Needs review
...
L["Fuel"] = "燃料"
L["Full Burning Ember"] = "完整的燃燒餘燼" -- Needs review
...
L["How many Chi points you currently have."] = "你目前有多少的氣點。" -- Needs review
...
L["How many Shadow Orbs you have if you're Shadow"] = "你有多少的暗影寶珠，如果你是暗牧" -- Needs review
...
L["If you can Spellsteal or remove an aura, then it will be shown scaled using the scaled aura size option."] = "如果你能法術偷取或移除一個光環，然後它會依光還縮放選項來縮放光環大小。" -- Needs review
...
L["Override background"] = "替代背景" -- Needs review
...
L["Percent HP"] = "百分比生命值"
L["Percent of the players current health that's being healed, if they have 100,000 total health and 15,000 is incoming then 15% is shown."] = "百分比顯示玩家目前受到治療的生命值，如果他們有100,000總生命並且受到15,000的治療則顯示15%。" -- Needs review
...
L["Primary means of coloring the power bar. Coloring by class only applies to players, for non-players it will default to the power type."] = "主要意義在於著色能量條，根據職業著色只限於玩家，非玩家單位能量條將為預設。" -- Needs review
...
L["Scale for auras that you casted or can Spellsteal, any number above 100% is bigger than default, any number below 100% is smaller than default."] = "縮放那些你施放或可法術偷取的光環，任何數字大於100%的將比預設的大，任何小於100%的將比預設的小。" -- Needs review
L["Screen"] = "螢幕"
L["Search"] = "搜尋"
L["Search tags"] = "搜尋標籤"
...
L["Sex"] = "性別"
L["%s frames"] = "%s框架"
L["Shadow Orbs"] = "暗影寶珠" -- Needs review
...
L["Shows what kind of pet the unit is for pet battles."] = "顯示什麼種類的寵物在寵物戰鬥的單位" -- Needs review
...
L["Whitelists"] = "白名單"
L["Whitelists will hide any aura not in the filter group.|nBlacklists will hide auras that are in the filter group."] = "白名單將會隱藏不在過濾群組的任何光環。/n黑名單將會隱藏在過濾群組的光環。" -- Needs review
L["Widget size"] = "比重大小"
L["Width"] = "寬"
